            ...
            <ul class="app-nav">
                ...
                <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown"><strong></strong><i class="fa fa-user fa-lg"></i></a>
                    <ul class="dropdown-menu settings-menu dropdown-menu-right">
                        <li><a href="adminTransactionHistory.php" class="dropdown-item"><i class="fa fa-money fa-lg"></i>( 24773935.75 )</a></li>
                    ...
                    <div class="col-lg-4" style="margin-bottom: 15px;">                            
                        <div class="bs-component">
                            <div class="list-group">
                                ...
                                <li class="list-group-item list-group-item-action "><h6>2nd Panel Admin & ScorePanel</h6></li>
