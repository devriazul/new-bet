    ...
    <div class="app-title" style="background: #AEB6BF;">
        <div>
            <h6><i class="fa fa-dashboard"></i> Total User Balance= 
                ...
                1094987.62                                || Total Gaining Amount= 102256376                || Total Sending Amount= 228030841.86                || Total Saving Amount= 4442760.86
                <span style="color: green">  || Total S Amount= 4025771.27</span>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="list-group">
                                        ...
                                        <span class="list-group-item btn btn-sm overAutoSubmit" matchId="" category="CB1">B1</span>
                                        <span class="list-group-item btn btn-sm overAutoSubmit" matchId="" category="CB2">B2</span>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">X</button>
...
<script type="text/javascript" src="js/plugins/bootstrap-datepicker.min.js"></script>
<script type="text/javascript" src="js/betActionAuto2.js"></script>
...
if(window.location.href.split('?')[1]){
    ...
    setTimeout(function(){
        $("#liveMatchFetch").load('betLiveContentAuto2.php',{matchId: url});
    },1000);
    //$("#liveMatchFetch").load('betLiveContentAuto2.php',{matchId: url});
}else{
    setTimeout(function(){
...
$(document).on('click', '#limitRateForQuestionSubmitCash', function (event) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            //page refresh
            $("#liveMatchFetch").load('betLiveContentAuto2.php',{matchId: match_id});
        }
    });
});
...
$(document).on('click', '.optionRateButt', function (event) {
    ...
    $.ajax({
        ...
        success: function (data) {
            $("#liveMatchFetch").load('betLiveContentAuto2.php',{matchId: matchId});
        }
    });
