...
<aside class="app-sidebar">
	...
	<div class="app-title">
	  <div>
		<i class="fa fa-users"></i> User Canceled Withdrwal History
	  </div>
	</div>
	<div class="row">
        <div class="col-md-12">
        	<div class="tile">
                <div class="tile-body">
                    <div class="table-responsive">
                    	<table class="table table-hover table-bordered" id="userAllWithdrwal">
                    		<thead>
                          <tr>
                            <th>No</th>
                            <th>User</th>
...
</html><script type="text/javascript">$('#userAllWithdrwal').DataTable();</script>