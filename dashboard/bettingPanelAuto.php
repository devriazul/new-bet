    ...
    <div class="app-title" style="background: #AEB6BF;">
        <div>
            <h6><i class="fa fa-dashboard"></i> Total User Balance= 
                ...
                1095185.62                                || Total Gaining Amount= 102256376                || Total Sending Amount= 228030841.86                || Total Saving Amount= 4442760.86
                <span style="color: green">  || Total S Amount= 4025773.27</span>
...
<script type="text/javascript" src="js/plugins/bootstrap-datepicker.min.js"></script>
<script type="text/javascript" src="js/betActionAuto.js"></script>
...
if(window.location.href.split('?')[1]){
    ...
    setTimeout(function(){
        $("#liveMatchFetch").load('betLiveContentAuto.php',{matchId: url});
    },1000);
    //$("#liveMatchFetch").load('betLiveContentAuto.php',{matchId: url});
}else{
    setTimeout(function(){
...
$(document).on('click', '#limitRateForQuestionSubmitCash', function (event) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            //page refresh
            $("#liveMatchFetch").load('betLiveContentAuto.php',{matchId: match_id});
        }
    });
});
