...
<main class="app-content">
    <div class="app-title" style="background: #AEB6BF;">
        <div>
            <h6><i class="fa fa-dashboard"></i> Total User Balance= 
               ...
               1095245.02                                || Total Gaining Amount= 102256376                || Total Sending Amount= 228030841.86                || Total Saving Amount= 4442760.86
                <span style="color: green">  || Total S Amount= 4025773.87</span>
    ...
    <div class="row" style="background: #AEB6BF;">
        ...
        <!-- limitMatch -->
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="list-group">
                                                ...
                                                <a href="#" class="list-group-item btn btn-sm section" g-type="2" id="1" data-toggle="modal" data-target="#hidden-section"> A1</a>
                                                
                                                <a href="#" class="list-group-item btn btn-sm section" g-type="2" id="2" data-toggle="modal" data-target="#hidden-section"> B1</a>
                                                                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">X</button>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="list-group">
                                                ...
                                                <a href="#" class="list-group-item btn btn-sm section" g-type="2" id="10" data-toggle="modal" data-target="#hidden-section"> A2</a>
                                                
                                                <a href="#" class="list-group-item btn btn-sm section" g-type="2" id="11" data-toggle="modal" data-target="#hidden-section"> B2</a>
                                                                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">X</button>
                    ...
                    <div id="defaultt" class="modal" style="">
                        <div class="modal-dialog modal-sm" role="document">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="list-group">
                    ...
                    <div id="defaultv" class="modal" style="">
                        <div class="modal-dialog modal-sm" role="document">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="list-group">
...
if(window.location.href.split('?')[1]){
    ...
    setTimeout(function(){
        $("#liveMatchFetch").load('betLiveContent.php',{matchId: url});
    },1000);
    //$("#liveMatchFetch").load('betLiveContent.php',{matchId: url});
}else{
    setTimeout(function(){
        $("#liveMatchFetch").load('betLiveOption.php');
    },1000);
    setTimeout(function(){
        $("#upcomingContent").load('betUpcomingOption.php');
    },1000);
    //$("#liveMatchFetch").load('betLiveOption.php');
    //$("#upcomingContent").load('betUpcomingOption.php');
}
...
$(document).on('click', '.hiddenToLiveOption', function (event) {
    ...
    $.ajax({
        ...
        success: function (data) {
            $("#hiddenOptionShow").load('hiddenOption.php',{question_id_for_total_show: match_id});
            $("#liveMatchFetch").load('betLiveContent.php',{matchId: match_id});
        }
    });
