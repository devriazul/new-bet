        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="form-group col-lg-8">
                        ...
                        <textarea name="notice" class="form-control" rows="5" id="comment"><p>৩০ মিনিটে withdraw দেওয়া হয়। Withdraw limit 500 to 25000 tk.&radic;&radic; [ 24 hours open] Deposit 100 to Unlimited.আপনাদের সর্ব্বোচ্চ সেবা দেওয়াটাই আমাদের মুল লক্ষ্য ৷</p>
</textarea>
                    </div>
